...
import numpy as np
import pandas as pd
from tools.data_loader import tran
from tools.u2net import U2NET, U2NETP
from tools.utils import model_evaluate
...
if __name__ == '__main__':
    test(load_model_path='./Lung_Seg/saved_models/u2netp/u2netp-100_20240921_150633.pth')
